        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <SectionHeader
            headerInfo={{
              title: "INTEGRATIONS",
              subtitle:
                "Integrate your Shopify Site with any of the third party provider",
              description:
                "We have experience setting up range of integrations with the shopify stores and we can help you connect your other existing systems with shopify.",
            }}
          />
        </div>
