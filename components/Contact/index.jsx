...
export default function Contact(){
    ...
    return (
      <>
        <section id="supoort" className="px-4 md:px-8 2xl:px-0">
            ...
            <div className="flex flex-wrap md:flex-nowrap flex-col-reverse md:flex-row gap-8 xl:gap-20 md:justify-between">
              ...
              >
                ...
                <div className="mb-7 5">
                  ...
                  <p>3220 Sheppard Avenue East, Toronto, ON, M1T 0B7</p>
                </div>
                <div className="mb-7 5">
                  <h4 className="font-medium text-black dark:text-white text-metatitle3 mb-4">
                    Email Address
                  ...
                  <p>
                    <a href="mailto:hello@thesjdevelopment.com">hello@thesjdevelopment.com</a>
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-black dark:text-white text-metatitle3 mb-4">
