...
export default function SectionHeader({headerInfo}){
    ...
    return(
        ...
        >
            <div className="bg-zumthor dark:bg-blacksection dark:border dark:border-strokedar inline-block rounded-full py-1.5 px-4.5 mb-4">
